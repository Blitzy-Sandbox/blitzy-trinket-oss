var _             = require('underscore'),
    ...
    //           HTTP client implementation changed. CSRF state-parameter audit (R7) for Google
    //           OAuth callbacks is tracked separately in lib/auth/passport.js per AAP §0.6.1.
