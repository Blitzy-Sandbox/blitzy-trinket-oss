...
module.exports = {
  ...
  upload : function(request, reply) {
    ...
    FileUtil.uploadMaterialFile(request.payload.upload, function(err, results) {
      ...
      var ext      = config.app.extensionWhitelist[fileExt] ? fileExt : mime.getExtension(contentType); // SECURITY: mime@3 API rename (was mime.extension); mitigates CVE-2017-16138
