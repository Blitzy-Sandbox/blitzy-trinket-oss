// SECURITY: @hapi/boom aliased as `Boom` to match this module's updateFolder/deleteFolder
//           Boom.forbidden() call sites (lines 139, 157); pre-existing alias `errors` was unused
//           by any call site and produced ReferenceError → HTTP 500 instead of HTTP 403 on cross-user
//           folder mutation attempts. Per AAP §0.5.2 Strategy G / R7 / OWASP A01 Broken Access
//           Control / CWE-639 IDOR.
